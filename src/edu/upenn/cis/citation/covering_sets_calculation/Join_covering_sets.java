...
public class Join_covering_sets {
  ...
  public static HashSet<Covering_set> join_views_curr_relation(ArrayList<Tuple> tuples, HashSet<Covering_set> curr_view_com, HashMap<Tuple, ArrayList<Integer>> view_mapping_query_arg_ids_mappings)
  {
      ...
      else
      {
          ...
          for(int i = 0; i<tuples.size(); i++)
          {
              ...
              if(valid_tuple.lambda_terms.size() > 0)
              {
                  ...
                  c = new citation_view_parametered(valid_tuple.name, valid_tuple.query, valid_tuple, view_mapping_query_arg_ids_mappings);
              }   
              else
              {
                  
                  c = new citation_view_unparametered(valid_tuple.name, valid_tuple, view_mapping_query_arg_ids_mappings);
              }
